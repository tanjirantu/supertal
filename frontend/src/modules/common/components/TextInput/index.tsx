    ...
    return (
        ...
        >
            ...
            >
                ...
                {type === 'password' && (
                    <div className="cursor-pointer flex items-center" onClick={handleEyesign}>
                        <PassEyeIcon
                            className={`fill-current ${
                                inputType === 'password' ? 'text-dh-gray-600' : 'text-dh-red-500'
                            } `}
                        />
                    </div>
                )}
...
export default Object.assign(TextInput, { Label });
